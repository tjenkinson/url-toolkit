...
describe('url toolkit', function() {
  describe('works with a selection of valid urls', function() {
    ...
    test('https://a.com/b/cd/e.m3u8?test=1#something', '/subdir/pointless/../z.ts?abc=1#test', 'https://a.com/subdir/z.ts?abc=1#test');
    test('https://a.com/b/cd/e.m3u8?test=1#something', '//example.com/subdir/pointless/../z.ts?abc=1#test', 'https://example.com/subdir/z.ts?abc=1#test');
